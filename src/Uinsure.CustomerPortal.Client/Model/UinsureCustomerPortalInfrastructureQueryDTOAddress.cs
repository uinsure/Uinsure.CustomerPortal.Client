...
{
    /// <summary>
    /// UinsureCustomerPortalInfrastructureQueryDTOAddress
    /// </summary>
    [DataContract(Name = "Uinsure.CustomerPortal.Infrastructure.Query.DTO.Address")]
    public partial class UinsureCustomerPortalInfrastructureQueryDTOAddress : IEquatable<UinsureCustomerPortalInfrastructureQueryDTOAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UinsureCustomerPortalInfrastructureQueryDTOAddress" /> class.
        /// </summary>
        ...
        public UinsureCustomerPortalInfrastructureQueryDTOAddress(string addressLine1 = default(string), string addressLine2 = default(string), string addressLine3 = default(string), string addressLine4 = default(string), string postcode = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UinsureCustomerPortalInfrastructureQueryDTOAddress {\n");
        ...
        {
            return this.Equals(input as UinsureCustomerPortalInfrastructureQueryDTOAddress);
        }

        /// <summary>
        /// Returns true if UinsureCustomerPortalInfrastructureQueryDTOAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of UinsureCustomerPortalInfrastructureQueryDTOAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UinsureCustomerPortalInfrastructureQueryDTOAddress input)
        {
            if (input == null)
            {
                return false;
