...
{
    /// <summary>
    /// UinsureCustomerPortalInfrastructureQueryDTOFindPoliciesResult
    /// </summary>
    [DataContract(Name = "Uinsure.CustomerPortal.Infrastructure.Query.DTO.FindPoliciesResult")]
    public partial class UinsureCustomerPortalInfrastructureQueryDTOFindPoliciesResult : IEquatable<UinsureCustomerPortalInfrastructureQueryDTOFindPoliciesResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UinsureCustomerPortalInfrastructureQueryDTOFindPoliciesResult" /> class.
        /// </summary>
        ...
        public UinsureCustomerPortalInfrastructureQueryDTOFindPoliciesResult(string policyNumber = default(string), DateTime? startDate = default(DateTime?), string policyType = default(string), string policyStatus = default(string), UinsureCustomerPortalInfrastructureQueryDTOAddress riskAddress = default(UinsureCustomerPortalInfrastructureQueryDTOAddress), string applicant1 = default(string), string applicant2 = default(string), DateTime? dateOfBirth = default(DateTime?), bool? dataQualityIssueFlag = default(bool?), bool? policyIssueFlag = default(bool?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UinsureCustomerPortalInfrastructureQueryDTOFindPoliciesResult {\n");
        ...
        {
            return this.Equals(input as UinsureCustomerPortalInfrastructureQueryDTOFindPoliciesResult);
        }

        /// <summary>
        /// Returns true if UinsureCustomerPortalInfrastructureQueryDTOFindPoliciesResult instances are equal
        /// </summary>
        /// <param name="input">Instance of UinsureCustomerPortalInfrastructureQueryDTOFindPoliciesResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UinsureCustomerPortalInfrastructureQueryDTOFindPoliciesResult input)
        {
            if (input == null)
            {
                return false;
