...
namespace Uinsure.CustomerPortal.Client.Model
{
    ...
    /// RenewalDetails
    /// </summary>
    [DataContract(Name = "RenewalDetails")]
    public partial class RenewalDetails : IEquatable<RenewalDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RenewalDetails" /> class.
        /// </summary>
        ...
        public RenewalDetails(Applicant client1 = default(Applicant), Applicant client2 = default(Applicant), Address riskAddress = default(Address), string propertyType = default(string), int numberOfBedrooms = default(int), string yearOfConstructionRange = default(string), bool buildingsCoverIncluded = default(bool), bool buildingsAccidentalDamageIncluded = default(bool), int buildingsCoverLimit = default(int), int buildingsExcess = default(int), int buildingsNoClaimsYears = default(int), bool contentsCoverIncluded = default(bool), bool contentsAccidentalDamageIncluded = default(bool), int contentsCoverLimit = default(int), int contentsExcess = default(int), int contentsNoClaimsYears = default(int), List<SpecifiedItem> contentsSpecifiedItems = default(List<SpecifiedItem>), int contentsPersonalPossessionsValue = default(int), bool homeEmergencyCover = default(bool), bool familyLegalProtection = default(bool), string quoteReference = default(string), DateTime policyStartDate = default(DateTime), Address correspondenceAddress = default(Address), QuotePremium quotePremium = default(QuotePremium), bool doNotAutoRenew = default(bool), DateTime renewalInceptionDate = default(DateTime))
        {
        ...
        public List<SpecifiedItem> ContentsSpecifiedItems
        {
        ...
        private List<SpecifiedItem> _ContentsSpecifiedItems;
        ...
        public QuotePremium QuotePremium
        {
        ...
        private QuotePremium _QuotePremium;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RenewalDetails {\n");
        ...
        {
            return this.Equals(input as RenewalDetails);
        }

        /// <summary>
        /// Returns true if RenewalDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of RenewalDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RenewalDetails input)
        {
            if (input == null)
            {
                return false;
