...
namespace Uinsure.CustomerPortal.Client.Model
{
    ...
    public partial class Applicant : IEquatable<Applicant>, IValidatableObject
    {
        ...
        public Applicant(string title = default(string), string firstName = default(string), string lastName = default(string), DateTime? dateOfBirth = default(DateTime?), string telephoneNumber = default(string), string emailAddress = default(string))
        {
            this._Title = title;
            if (this.Title != null)
            {
